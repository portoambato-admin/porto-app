...
class _PanelScreenState extends State<PanelScreen>
        ...
        bottom: isAdmin
            ? PreferredSize(
                ...
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    const AdminSectionTabs(current: AdminSection.usuarios),
                    Material(
  ...
  Future<void> _openEditUserDialog(Map<String, dynamic> u) async {
    ...
    int idRol = (u['id_rol'] as int?) ?? 3; // por defecto Padre
  ...
  Future<void> _activateUser(Map<String, dynamic> u) async {
    ...
    try {
      ...
      // ✅ usar endpoint dedicado POST /usuarios/:id/activar
      await ApiService.activarUsuario(token: token, idUsuario: id);
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  tooltip: 'Siguiente',
                  onPressed:
                      (to < total) ? () => onPageChange(page + 1) : null,
